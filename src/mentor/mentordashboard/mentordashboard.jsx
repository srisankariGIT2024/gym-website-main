...
const navigation = [
    { name: 'Dashboard', href: '/mentordashboard', current: true },
        ...
        <>
            ...
            <div className="min-h-full">
                ...
                <main>
                    ...
                    <div className="mx-auto max-w-7xl bg-white px-4 py-6 sm:px-6 lg:px-8"><ul role="list" className="divide-y divide-gray-100">
                        {people.map((person) => (
